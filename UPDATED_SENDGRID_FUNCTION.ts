...
serve(async (req) => {
  ...
  try {
    ...
    let emailSettings = {
      fromAddress: 'noreply@imaginecapital.ai',
      replyToAddress: 'noreply@imaginecapital.ai',
    ...
    if (companyId) {
      ...
      if (company) {
        emailSettings = {
          fromAddress: company.email_from_address || 'noreply@imaginecapital.ai',
          replyToAddress: company.email_reply_to_address || 'noreply@imaginecapital.ai',
    ...
    // If DNS not verified, force use of default domain
    if (!emailSettings.dnsVerified) {
      emailSettings.fromAddress = 'noreply@imaginecapital.ai'
      emailSettings.replyToAddress = 'noreply@imaginecapital.ai'
    }
...
Dashboard: https://leads.imaginecapital.ai`
    ...
    const emailPayload = {
      ...
      reply_to: {
        email: emailSettings.replyToAddress,
        name: emailSettings.fromName
      },
      content: [
        {
