...
const ProfileModal: React.FC<ProfileModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 transition-opacity p-4">
      <div className="bg-slate-100 dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative animate-fade-in-up text-slate-800 dark:text-white">
        <div className="sticky top-0 bg-slate-100 dark:bg-slate-800 p-6 md:p-8 pb-4 border-b border-slate-200 dark:border-slate-700">
